        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           connection.Open();
            ...
            SqlDataReader dr = cmd.ExecuteReader();
                if (dr.Read() == false)
            {
                MetroFramework.MetroMessageBox.Show(this, "\n\n The username or password are wrong, Please check ", "Something went wrong", MessageBoxButtons.YesNo, MessageBoxIcon.Error);
            ...
            else
            {
               ...
               // MetroFramework.MetroMessageBox.Show(this, "\n\n You have successfully connected ", "Hello"+ LoginInfo.prenom+ " "+ LoginInfo.nom, MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                MetroFramework.MetroMessageBox.Show(this, "You have SUCCESSFULLY connected \n\n Welcome " + LoginInfo.prenomMed + " " + LoginInfo.nomMed, "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
