...
namespace WindowsFormsApp3
{
    public partial class Form6 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (dr.Read() == false)
            {
                MetroFramework.MetroMessageBox.Show(this, "\n\n The username or password are wrong, Please check ", "Something went wrong", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            else
            {
                ...
                MetroFramework.MetroMessageBox.Show(this, "You have SUCCESSFULLY connected \n\n Welcome "+ LoginInfo.nom+" "+ LoginInfo.prenom, "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
